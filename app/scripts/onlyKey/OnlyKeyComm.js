...
var OnlyKeyHID = function (onlyKeyConfigWizard) {
    ...
    var handleMessage = async function (err, msg) {
        ...
        if (myOnlyKey.isBootloader || !myOnlyKey.isInitialized ) { //Firmware load in app without config mode
          ...
          step4text.innerHTML = "Backup passphrase is not available on this firmware version. To load latest firmware follow the loading instructions <a href='https://docs.crp.to/usersguide.html#loading-onlykey-firmware' class='external'>here</a>";
        }
